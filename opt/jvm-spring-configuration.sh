...
ENV_MAPPINGS=(
	...
	"REDIS_URL:SPRING_DATA_REDIS_URL:DISABLE_SPRING_REDIS_URL"
	# Heroku Managed Inference and Agents (MIA)
	"INFERENCE_KEY:SPRING_AI_OPENAI_APIKEY:DISABLE_SPRING_AI_CONFIG"
	"INFERENCE_URL:SPRING_AI_OPENAI_BASEURL:DISABLE_SPRING_AI_CONFIG"
	"INFERENCE_MODEL_ID:SPRING_AI_OPENAI_CHAT_OPTIONS_MODEL:DISABLE_SPRING_AI_CONFIG"
)
