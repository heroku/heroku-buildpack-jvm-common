...
* A failed download of the Heroku JVM metrics agent no longer writes the HTTP error response into the agent JAR, which stopped the app's JVM from starting. The build now fails with an error instead. ([#468](https://github.com/heroku/heroku-buildpack-jvm-common/pull/468))
...
* Upgrade default JDKs to `26.0.2.1`, `25.0.4.1`, `21.0.12.1`, `17.0.20.1`, `11.0.32.1` and `8u504`. ([#454](https://github.com/heroku/heroku-buildpack-jvm-common/pull/454))

## [v183] - 2026-07-22

### Changed

* Upgrade default JDKs to `26.0.2`, `25.0.4`, `21.0.12`, `17.0.20`, `11.0.32` and `8u502`. ([#450](https://github.com/heroku/heroku-buildpack-jvm-common/pull/450))
