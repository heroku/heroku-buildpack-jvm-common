...
LATEST_ZULU_OPENJDK_27_STRING = 'OpenJDK Runtime Environment Zulu27.28+101-CA (build 27+35)'
...
EXPECTED_JAVA_VERSIONS = {
  'heroku-22' => {
    ...
    '27' => LATEST_ZULU_OPENJDK_27_STRING,
    'zulu-21' => LATEST_ZULU_OPENJDK_21_STRING,
    '21.0.12.1' => LATEST_ZULU_OPENJDK_21_STRING,
  },
  'heroku-24' => {
...
FILE_MD5_HASHES = {
  ...
  '.profile.d/jvm-spring-configuration.sh' => '59c34e5c1611e2c06182c5ea3d5ad7fd',
  ...
  '.heroku/bin/heroku-metrics-agent.jar' => '3ef2635b3f8bde05fb2d79cd454778df',
